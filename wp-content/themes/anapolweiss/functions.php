...
function twentyten_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Recent Posts Widget Area', 'twentyten' ),
		'id' => 'recent-posts-area',
		'description' => __( 'Add widgets here to appear in your blog sidebar.', 'twentyten' ),
	...
	register_sidebar( array(
		'name' => __( 'Topics Widget Area', 'twentyten' ),
		'id' => 'topics-widget-area',
		'description' => __( 'Add widgets here to appear in your blog sidebar.', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
...
function twentyten_posted_in() {
	...
	if ( $tag_list ) {
		...
		$posted_in = __( '<span class="orange">Topics</span> %1$s', 'twentyten' );
	} else {
...
function my_update_comment_field( $comment_field ) {
  ...
  $comment_field =
    '<p class="comment-form-comment">
            ...
            <textarea required id="comment" name="comment" placeholder="' . esc_attr__( "Comments*", "text-domain" ) . '" cols="45" rows="8" aria-required="true"></textarea>
        </p>';
